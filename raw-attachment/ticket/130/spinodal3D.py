...
import math
nx = int(math.pow(numberOfElements, 1./3.0))
ny = int(math.pow(numberOfElements, 1./3.0))
nz =  int(math.pow(numberOfElements, 1.0/3.0))
steps = numberOfSteps
...
BCs = (FixedFlux(mesh.getFacesRight(), 0),
       ...
       NthOrderBoundaryCondition(mesh.getFacesFront(), 0, 3),
       NthOrderBoundaryCondition(mesh.getFacesBack(), 0, 3),
       )
